...
class TribalRelationsWindow(ctk.CTkToplevel):
    ...
    def __init__(self, parent, world):
        ...
        self.location_label = ctk.CTkLabel(
            self,
            text=(
                f"{get_location_name('queen_palace')}\n"
                f"Dragons here:\n{get_dragons_here_text(self.world, 'queen_palace')}"
            ),
            font=("Arial", 12),
            text_color="#BDBDBD",
            justify="left"
        )
        self.location_label.grid(row=0, column=0, columnspan=2, sticky="ew", padx=12, pady=(8, 4))  
    ...
    def create_roster_panel(self):
        ...
        self.left_frame.grid(row=1, column=0, sticky="nsew", padx=8, pady=8)
    ...
    def create_detail_panel(self):
        ...
        self.right_frame.grid(row=1, column=1, sticky="nsew", padx=8, pady=8)
