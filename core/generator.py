...
def generate_starting_world(starting_tribe="mixed"):
    tribe_map = {
        "skywing": "SkyWing",
        "seawing": "SeaWing",
        "rainwing": "RainWing",
    ...
    selected_tribe = tribe_map.get(str(starting_tribe).lower(), "Mixed")

    if selected_tribe == "Mixed":
