...
def handle_personal_choice(world, option_id):
    ...
    if choice["type"] == "injured_patrol_choice":
        ...
        if option_id == "back_down":
            ...
            support_bias = support_a - support_b
            ...
            spread_rumor(world, source_id=a.id, target_id=a.id, effect=-0.3)
            spread_rumor(world, source_id=b.id, target_id=b.id, effect=0.2)
            ...
            if random.random() < injury_chance:
                ...
                log_event(
                    world,
                    f"{a.name} and {b.name} clashed, but neither gained the upper hand.",
                    involved_ids=[a.id, b.id],
                    event_type="stalemate",
                    importance=3
                )
